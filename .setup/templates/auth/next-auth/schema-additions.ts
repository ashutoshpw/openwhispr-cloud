/**
 * Schema additions for NextAuth
 *
 * These tables are required for NextAuth to function.
 * They should be added to the base schema.
 *
 * Note: NextAuth uses similar tables to Better Auth, with the same structure
 * for compatibility with @auth/drizzle-adapter.
 */
...
// Session table - stores active sessions (not used with JWT strategy, but kept for adapter compatibility)
