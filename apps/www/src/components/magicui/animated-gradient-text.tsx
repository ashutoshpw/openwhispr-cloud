...
export default function AnimatedGradientText({
  ...
  return (
    ...
    >
      <div
        className={
          "absolute inset-0 block h-full w-full animate-gradient bg-linear-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 [background-size:var(--bg-size)_100%] p-px [mask-composite:subtract]! rounded-[inherit] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)]"
        }
      />
