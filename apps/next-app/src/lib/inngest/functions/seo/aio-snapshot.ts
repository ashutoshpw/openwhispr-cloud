/**
 * Weekly Google AI Overview presence cron. For each active seo_keywords row,
 * calls DataForSEO ai_overview/live/advanced and writes seo_aio_presence.
 *
 * Cron: Mondays 04:30 UTC (`30 4 * * 1`)
 */

import { googleAioEngine } from "@/lib/aieo/engines/google-aio";
import { getSecret } from "@/lib/aieo/secrets/store";
import { getSetting } from "@/lib/aieo/settings/store";
import {
  hasAioPresenceOnDate,
  insertAioPresence,
} from "@/lib/dal/seo/aio-presence";
