 ...
 *
 * Pulls last 3 days of (date, page) totals + (date, page, query) rows and
 * upserts into seo_gsc_daily. Idempotent.
 *
 * Cron: every day 04:00 UTC (`0 4 * * *`)
 */

import { upsertGscRows } from "@/lib/dal/seo/gsc";
import { fetchGscRows } from "@/lib/gsc/client";
