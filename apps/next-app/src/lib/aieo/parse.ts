 ...
 *
 * Brand and competitor detection works on lowercased domain matches with
 * subdomain + www stripping. Mention rank is the 1-indexed character position
 * of the first brand mention — useful as a ranking signal.
 */
...
/**
 * 1-indexed character position of the first brand mention; looks for either
 * the bare brand name (domain's leftmost label) or the full target domain.
 */
...
/**
 * Rule-based sentiment fallback when no LLM classifier is configured.
 */
