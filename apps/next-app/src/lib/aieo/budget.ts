/**
 * Per-run weekly budget guard. Cron iterates engines × prompts and accumulates
 * costCents; before each call it asks `assertWithinBudget()` and aborts if
 * the call would push total past the cap.
 */
