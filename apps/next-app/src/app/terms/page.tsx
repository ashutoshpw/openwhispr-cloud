      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              We provide a software-as-a-service platform that enables users to build and manage
              their applications. We reserve the right to modify, suspend, or discontinue any part
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              or password. You must notify us immediately of any unauthorized use of your account.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              If you purchase a subscription, you agree to pay the fees specified at the time of
              purchase. All fees are non-refundable except as required by law. We reserve the right
              to change our pricing with 30 days notice to existing customers.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              arising out of the use or inability to use the materials on our service, even if we
