/**
 * @repo/auth/authkit/client - WorkOS AuthKit client implementation
 * Import via: import { signIn, signOut, useSession } from "@repo/auth/authkit/client"
 */
"use client";
...
function getClientInstance(): AuthKitClient {
  if (!clientInstance) {
