...
jobs:
  deploy:
    ...
    strategy:
      ...
      matrix:
        include:
          - { app: www,   working_directory: apps/www,   project_id: prj_p1DeT78RzflBid8YvCHjI5eIJlJc, project_name: openwhispr-www,   alias_prefix: openwhispr-www }
          - { app: api,   working_directory: apps/api,   project_id: prj_Fkke6EqdAmQ5FkMVqdCVN9jiOUvC, project_name: openwhispr-api,   alias_prefix: openwhispr-api }
          - { app: auth,  working_directory: apps/auth,  project_id: prj_HhI4HOv3ZR9DGKR65dzKHGvV2vrZ, project_name: openwhispr-auth,  alias_prefix: openwhispr-auth }
          - { app: notes, working_directory: apps/notes, project_id: prj_O6paA2AkfjUpmkFjsx6CdQMWTmLy, project_name: openwhispr-notes, alias_prefix: openwhispr-notes }
          - { app: admin, working_directory: apps/admin, project_id: prj_JsmYl8TcnfVUlSMC2uDZGkWczOGd, project_name: openwhispr-admin, alias_prefix: openwhispr-admin }
          - { app: mcp,   working_directory: apps/mcp,   project_id: prj_BURLxASe6bsyxBFEjnn7IXaUsAl5, project_name: openwhispr-mcp,   alias_prefix: openwhispr-mcp }
    steps:
